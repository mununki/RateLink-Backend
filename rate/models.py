...
class Rate(models.Model):
    inputperson = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, null=True, blank=False, related_name='inputperson')
    account = models.ForeignKey(Client, on_delete=models.CASCADE, null=True, blank=False, related_name='rate')
    liner = models.ForeignKey(Liner, on_delete=models.CASCADE, null=True, blank=False, related_name='rate')
    pol = models.ForeignKey(Location, on_delete=models.CASCADE, null=True, blank=False, related_name='ratepol')
    pod = models.ForeignKey(Location, on_delete=models.CASCADE, null=True, blank=False, related_name='ratepod')
    type = models.ForeignKey(CNTRtype, on_delete=models.CASCADE, null=True, blank=False, related_name='rate')
    ...
    offeredDate = models.DateTimeField(default=timezone.now, blank=True)
    effectiveDate = models.DateTimeField(default=timezone.now, blank=True)
