...
class RateReader(models.Model):
    shower = models.ForeignKey(MyUser, null=True, on_delete=models.CASCADE, related_name='who_shows')
    reader = models.ForeignKey(MyUser, null=True, on_delete=models.CASCADE, related_name='who_reads')
...
class MyUserProfile(models.Model):
    ...
    job_boolean = models.CharField(choices=JOB_CHOICE, max_length=2, blank=True, null=True)
